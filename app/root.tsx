    ...
    <Document>
      <div className="min-h-screen flex flex-col">
        <header className="flex flex-row sm:px-10 p-5 border-b">
          ...
          <a className="inline-block text-gray-600 hover:text-black transition-colors" href="https://github.com/edmundhung/remix-worker-template" target="_blank" rel="noopener noreferrer">
